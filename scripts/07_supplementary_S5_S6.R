...
#           (produces data/metafile_master.csv)
# Input:    data/metafile_master.csv
#           data/otu_table_decontam.csv
#           data/taxonomy.txt
# Output:   output/figures/FigS5_Cluster_Transitions_Standard.svg/.pdf
#           output/figures/FigS6_Cluster_Transitions_Venner.svg/.pdf
# =============================================================================
...
sample_info   <- read.csv(file.path(data_dir, "metafile_master.csv"),
...
ggsave(file.path(output_dir, "FigS5_Cluster_Transitions_Standard.svg"),
       fig_s3, width = 26, height = 18, units = "cm")
ggsave(file.path(output_dir, "FigS5_Cluster_Transitions_Standard.pdf"),
...
ggsave(file.path(output_dir, "FigS6_Cluster_Transitions_Venner.svg"),
       fig_s4, width = 26, height = 18, units = "cm")
ggsave(file.path(output_dir, "FigS6_Cluster_Transitions_Venner.pdf"),
